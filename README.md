![](https://img.shields.io/badge/Licence-Apache%202.0-green.svg)  ![](https://img.shields.io/badge/android-%3E%205.0-blue)  
        ...
        if (message instanceof dBError) {
            ...
            switch(dberror.code)
            {
                case "ERR_socket_ratelimit_exceeded":
                	Log.i("Socket ratelimit Exceeded");
                    break;
                case "ERR_ratelimit_exceeded":
                	Log.i("Customer ratelimit Exceeded", dberror.message);
                    break;
                case "ERR_ratelimit_restored":
                	Log.i("Customer ratelimit Restored");
                    break;
                case "ERR_concurrent_connection_limit":
                	Log.i("Customer Connection limit Exceeded.");
                    break;
                default:
                	Log.i("connect_error:",   dberror.code + ","  +  dberror.message);
                    break;
            }
        }
    }
